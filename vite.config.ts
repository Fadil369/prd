...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'من الفكرة إلى السوق - Idea to Market',
        short_name: 'Idea2Market',
        description: 'منصة مدعومة بالذكاء الاصطناعي لرواد الأعمال السعوديين - AI-powered platform for Saudi entrepreneurs',
        theme_color: '#059669',
        ...
        shortcuts: [
          ...
          },
          {
            ...
            short_name: 'مستند',
            description: 'إنشاء مستند متطلبات المنتج - Create Product Requirements Document',
            url: '/?step=prd',
