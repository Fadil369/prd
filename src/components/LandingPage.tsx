      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-24 sm:py-32">
          <div className="text-center max-w-5xl mx-auto">
            ...
            {/* Subtitle */}
            <p className={`
              text-xl sm:text-2xl text-neutral-600
      ...
      <section className="py-24 bg-white/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={`
              text-4xl sm:text-5xl font-bold text-neutral-900 mb-6
              ${isRTL ? 'font-arabic' : 'font-english'}
            `}>
              {t('features')}
            </h2>
            <p className={`
              text-xl text-neutral-600 max-w-2xl mx-auto
              ${isRTL ? 'font-arabic' : 'font-english'}
            `}>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="mb-6 flex justify-center">
                  <div className="p-4 rounded-2xl bg-gradient-to-br from-primary-50 to-secondary-50 group-hover:scale-110 transition-transform duration-300">
                    {feature.icon}
                  </div>
                </div>
                
                <h3 className={`
                  text-xl font-semibold text-neutral-900 mb-4
                  ${isRTL ? 'font-arabic' : 'font-english'}
                `}>
                  {t(feature.titleKey)}
                </h3>
      ...
      <section className="py-24 bg-gradient-to-br from-neutral-50 to-primary-50">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className={`
              text-xl text-neutral-600 mb-12 leading-relaxed
              ${isRTL ? 'font-arabic' : 'font-english'}
            `}>
